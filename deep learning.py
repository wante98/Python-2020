...
# -*- coding: utf-8 -*-
"""
Created on Wed Aug 26 17:14:00 2020
...
dataset_train = pd.read_csv('/content/drive/My Drive/lstmdata/tsmc_training.csv')
...
dataset_test = pd.read_csv('/content/drive/My Drive/lstmdata/tsmc_test.csv')
